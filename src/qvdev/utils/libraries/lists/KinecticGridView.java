...
public class KinecticGridView extends GridView implements AbsListView.OnScrollListener
{
    ...
    public KinecticGridView(Context context)
    {
        super(context);
    ...
    public KinecticGridView(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    public KinecticGridView(Context context, AttributeSet attrs, int defStyle)
    {
